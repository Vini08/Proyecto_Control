...
Border thickBorde = new LineBorder(Color.WHITE, 4);
   ...
   Color BTNmenuMousePressed =new Color(95,122,148); 
    ...
    private void initComponents() {
        ...
        jButton6.setFont(new java.awt.Font("Microsoft Yi Baiti", 1, 21)); // NOI18N
        ...
        jButton10.setFont(new java.awt.Font("Microsoft Yi Baiti", 1, 21)); // NOI18N
        jButton10.setForeground(new java.awt.Color(16, 16, 16));
        jButton10.setText("   Datos de Medidor");
...
jPanel2.removeAll();
jPanel2.repaint();
Listado_Recibos list = new Listado_Recibos();
jPanel2.add(list);
...
jPanel2.removeAll();
jPanel2.repaint();
Registrar_Cliente nw = new Registrar_Cliente();
jPanel2.add(nw);
nw.show();
// TODO add your handling code here:
...
jPanel2.removeAll();
jPanel2.repaint();
Eliminar_Cliente del = new Eliminar_Cliente();
jPanel2.add(del);
del.show(); 
// TODO add your handling code here:
...
jPanel2.removeAll();
jPanel2.repaint();
Editar_Cliente ed = new Editar_Cliente();
jPanel2.add(ed);
...
jButton9.setOpaque(true);        // Codigo para que vuelva el color de fondo original del boton cuando se quita el mouse
    ...
    private void jButton10MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton10MousePressed
        // TODO add your handling code here:
        jButton10.setBackground(BTNmenuMousePressed);
        jButton10.setOpaque(true);
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        jPanel2.removeAll();
        jPanel2.repaint();
        Registrar_Medidor del = new Registrar_Medidor();
        jPanel2.add(del);
        del.show(); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Supervisor_Cajero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Supervisor_Cajero().setVisible(true);
            }
        });
    }
